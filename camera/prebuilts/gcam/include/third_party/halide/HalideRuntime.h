...
typedef enum halide_target_feature_t {
    ...
    halide_target_feature_ipu = 43, ///< Enable the IPU runtime
    halide_target_feature_ipu_fp32 = 44, ///< Enable the IPU 32-bit floating point support
    // End Google Paintbox modification
    halide_target_feature_end = 45 ///< A sentinel. Every target is considered to have this feature, and setting this feature does nothing.
