#ifndef HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_AE_AE_SHOT_PARAMS_H_
#define HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_AE_AE_SHOT_PARAMS_H_
...
#endif  // HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_AE_AE_SHOT_PARAMS_H_
