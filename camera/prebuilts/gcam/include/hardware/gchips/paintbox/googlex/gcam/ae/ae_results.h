#ifndef HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_AE_AE_RESULTS_H_
#define HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_AE_AE_RESULTS_H_
...
struct AeResults {
  ...
  float FinalHdrRatio() const {
    return final_tet[kHdrLong] / final_tet[kHdrShort];
  }
...
#endif  // HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_AE_AE_RESULTS_H_
