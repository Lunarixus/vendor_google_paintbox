#ifndef HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_IMAGE_RAW_RAW_BUFFER_LAYOUT_H_
#define HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_IMAGE_RAW_RAW_BUFFER_LAYOUT_H_

#include "third_party/halide/HalideBuffer.h"
#include "third_party/halide/HalideRuntime.h"
...
void GetRawBufferBounds(RawBufferLayout layout,
                        const Halide::Runtime::Buffer<const void>& raw,
...
Halide::Runtime::Buffer<const void> AdjustRawBufferMins(
    RawBufferLayout layout, Halide::Runtime::Buffer<const void> raw, int dx,
    int dy);

}  // namespace gcam

#endif  // HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_IMAGE_RAW_RAW_BUFFER_LAYOUT_H_
