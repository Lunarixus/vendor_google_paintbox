#ifndef HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_FINISH_YUV_SHARPENER_H_
#define HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_FINISH_YUV_SHARPENER_H_
...
#endif  // HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_FINISH_YUV_SHARPENER_H_
