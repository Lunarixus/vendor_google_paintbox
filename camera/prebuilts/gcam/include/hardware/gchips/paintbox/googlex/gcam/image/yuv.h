#ifndef HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_IMAGE_YUV_H_
#define HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_IMAGE_YUV_H_
...
class YuvImage : public YuvWriteView {
 public:
  ...
  // TODO(ruiduoy): Remove this function.
  // Replaces the luma and chroma sub-images with new ones.
  // The YuvImage deletes its existing luma and chroma images,
  // and takes ownership of the new luma and chroma images.
  void ReplaceLumaAndChroma(InterleavedImageU8&& luma,
                            InterleavedImageU8&& chroma);
...
#endif  // HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_IMAGE_YUV_H_
