#ifndef HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_BASE_PIXEL_RECT_H_
#define HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_BASE_PIXEL_RECT_H_
...
#endif  // HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_BASE_PIXEL_RECT_H_
