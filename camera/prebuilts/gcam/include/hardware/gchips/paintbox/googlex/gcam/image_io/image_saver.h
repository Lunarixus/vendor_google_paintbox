#ifndef HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_IMAGE_IO_IMAGE_SAVER_H_
#define HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_IMAGE_IO_IMAGE_SAVER_H_
...
class ImageSaver {
 public:
  ...
  std::string Save(const YuvReadView& map, const char* filename);
  std::string Save(const PlanarReadViewU8& yuv888, const char* filename);
...
#endif  // HARDWARE_GCHIPS_PAINTBOX_GOOGLEX_GCAM_IMAGE_IO_IMAGE_SAVER_H_
