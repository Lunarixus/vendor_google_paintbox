#ifndef GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_SHOT_LOG_DATA_H_
#define GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_SHOT_LOG_DATA_H_
...
#endif  // GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_SHOT_LOG_DATA_H_
