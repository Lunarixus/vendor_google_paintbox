#ifndef GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_GCAM_CONSTANTS_H_
#define GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_GCAM_CONSTANTS_H_
...
#endif  // GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_GCAM_CONSTANTS_H_
