#ifndef GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_GCAM_TYPES_H_
#define GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_GCAM_TYPES_H_
...
#endif  // GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_GCAM_TYPES_H_
