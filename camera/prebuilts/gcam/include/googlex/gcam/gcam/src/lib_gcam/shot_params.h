#ifndef GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_SHOT_PARAMS_H_
#define GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_SHOT_PARAMS_H_
...
#endif  // GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_SHOT_PARAMS_H_
