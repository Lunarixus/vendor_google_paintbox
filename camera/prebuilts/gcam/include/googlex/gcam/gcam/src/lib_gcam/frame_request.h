#ifndef GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_FRAME_REQUEST_H_
#define GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_FRAME_REQUEST_H_
...
#endif  // GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_FRAME_REQUEST_H_
