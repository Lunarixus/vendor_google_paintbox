#ifndef GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_TUNING_H_
#define GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_TUNING_H_
...
struct RawFinishParams {
  ...
  // Relative strength of chroma denoising, 1.0 is normal.
...
#endif  // GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_TUNING_H_
