#ifndef GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_GCAM_CALLBACKS_H_
#define GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_GCAM_CALLBACKS_H_
...
#include "googlex/gcam/gcam/src/lib_gcam/shot_log_data.h"
...
#endif  // GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_GCAM_CALLBACKS_H_
