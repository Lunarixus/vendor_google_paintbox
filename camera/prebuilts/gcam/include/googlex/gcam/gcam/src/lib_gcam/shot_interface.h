#ifndef GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_SHOT_INTERFACE_H_
#define GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_SHOT_INTERFACE_H_
...
#endif  // GOOGLEX_GCAM_GCAM_SRC_LIB_GCAM_SHOT_INTERFACE_H_
