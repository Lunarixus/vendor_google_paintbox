...
#include "third_party/halide/halide/src/runtime/HalideBuffer.h"
...
void GetRawBufferBounds(RawBufferLayout layout,
                        const Halide::Buffer<const void>& raw,
                        int* min_x, int* min_y,
...
Halide::Buffer<const void>
AdjustRawBufferMins(RawBufferLayout layout,
                    Halide::Buffer<const void> raw,
                    int dx, int dy);
