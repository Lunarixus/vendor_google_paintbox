...
public:
    ...
    struct BlockMetadata {
        ...
        // Request metadata for HDR+ processing. This will be assigned before queueing a request
        // to HdrPlusProcessingBlock.
        std::shared_ptr<RequestMetadata> requestMetadata;
