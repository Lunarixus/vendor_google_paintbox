...
#define LOG_TAG "PaintboxDriverOem"
...
class PaintboxDriverOem : public PaintboxDriver {
public:
    PaintboxDriverOem() : PaintboxDriver() {}
    Return<void> getCapabilities(getCapabilities_cb _hidl_cb) override;
    Return<void> getSupportedOperations(const Model& model, getSupportedOperations_cb cb) override;
};

Return<void> PaintboxDriverOem::getCapabilities(getCapabilities_cb cb) {
...
using android::nn::paintbox_driver::PaintboxDriverOem;
using android::sp;

int main() {
    sp<PaintboxDriverOem> driver(new PaintboxDriverOem());
    return driver->run();
}
